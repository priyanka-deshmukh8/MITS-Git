...
- Based on your contribution file `your-github-username.mdx` MITSgit authenticates you.
- Make your profile publically visible as

```
https://www.MITS-Git/contributors/<your-github-username>
```
